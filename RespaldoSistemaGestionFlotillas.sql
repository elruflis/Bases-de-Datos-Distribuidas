...
--
-- Temporary view structure for view `conductores_info_licencia`
--

DROP TABLE IF EXISTS `conductores_info_licencia`;
/*!50001 DROP VIEW IF EXISTS `conductores_info_licencia`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `conductores_info_licencia` AS SELECT 
 1 AS `conductorId`,
 1 AS `numeroLicencia`,
...
--
-- Temporary view structure for view `conductores_info_personal`
--

DROP TABLE IF EXISTS `conductores_info_personal`;
/*!50001 DROP VIEW IF EXISTS `conductores_info_personal`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `conductores_info_personal` AS SELECT 
 1 AS `conductorId`,
 1 AS `nombre`,
 1 AS `estado`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `documentos_archivos`
--

DROP TABLE IF EXISTS `documentos_archivos`;
/*!50001 DROP VIEW IF EXISTS `documentos_archivos`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `documentos_archivos` AS SELECT 
 1 AS `documentoId`,
 1 AS `rutaArchivo`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `documentos_info_basica`
--

DROP TABLE IF EXISTS `documentos_info_basica`;
/*!50001 DROP VIEW IF EXISTS `documentos_info_basica`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `documentos_info_basica` AS SELECT 
 1 AS `documentoId`,
 1 AS `vehiculoId`,
 1 AS `tipo`,
...
--
-- Temporary view structure for view `mantenimiento_info_costo`
--

DROP TABLE IF EXISTS `mantenimiento_info_costo`;
/*!50001 DROP VIEW IF EXISTS `mantenimiento_info_costo`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `mantenimiento_info_costo` AS SELECT 
...
--
-- Temporary view structure for view `mantenimiento_info_servicio`
--

DROP TABLE IF EXISTS `mantenimiento_info_servicio`;
/*!50001 DROP VIEW IF EXISTS `mantenimiento_info_servicio`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `mantenimiento_info_servicio` AS SELECT 
 1 AS `mantenimientoId`,
 1 AS `vehiculoId`,
 1 AS `fechaServicio`,
 1 AS `tipoServicio`,
...
--
-- Temporary view structure for view `rutas_info_conductor`
--

DROP TABLE IF EXISTS `rutas_info_conductor`;
/*!50001 DROP VIEW IF EXISTS `rutas_info_conductor`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `rutas_info_conductor` AS SELECT 
 1 AS `rutaId`,
 1 AS `conductorId`,
 1 AS `estado`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `rutas_info_ruta`
--

DROP TABLE IF EXISTS `rutas_info_ruta`;
/*!50001 DROP VIEW IF EXISTS `rutas_info_ruta`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `rutas_info_ruta` AS SELECT 
 1 AS `rutaId`,
 1 AS `vehiculoId`,
 1 AS `horaInicio`,
 1 AS `horaFin`,
...
--
-- Temporary view structure for view `rutas_pendientes`
--

DROP TABLE IF EXISTS `rutas_pendientes`;
/*!50001 DROP VIEW IF EXISTS `rutas_pendientes`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `rutas_pendientes` AS SELECT 
 1 AS `rutaId`,
 1 AS `vehiculoId`,
 1 AS `conductorId`,
 1 AS `horaInicio`,
...
--
-- Temporary view structure for view `transacciones_diesel`
--

DROP TABLE IF EXISTS `transacciones_diesel`;
/*!50001 DROP VIEW IF EXISTS `transacciones_diesel`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `transacciones_diesel` AS SELECT 
 1 AS `transaccionId`,
 1 AS `vehiculoId`,
 1 AS `conductorId`,
 1 AS `monto`,
...
--
-- Temporary view structure for view `transacciones_gasolina`
--

DROP TABLE IF EXISTS `transacciones_gasolina`;
/*!50001 DROP VIEW IF EXISTS `transacciones_gasolina`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `transacciones_gasolina` AS SELECT 
 1 AS `transaccionId`,
 1 AS `vehiculoId`,
 1 AS `conductorId`,
 1 AS `monto`,
...
--
-- Temporary view structure for view `vehiculos_anio_2020`
--

DROP TABLE IF EXISTS `vehiculos_anio_2020`;
/*!50001 DROP VIEW IF EXISTS `vehiculos_anio_2020`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vehiculos_anio_2020` AS SELECT 
 1 AS `vehiculoId`,
 1 AS `flotillaId`,
 1 AS `tipo`,
 1 AS `modelo`,
...
--
-- Temporary view structure for view `vehiculos_anio_2021`
--

DROP TABLE IF EXISTS `vehiculos_anio_2021`;
/*!50001 DROP VIEW IF EXISTS `vehiculos_anio_2021`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vehiculos_anio_2021` AS SELECT 
 1 AS `vehiculoId`,
 1 AS `flotillaId`,
 1 AS `tipo`,
 1 AS `modelo`,
...
--
-- Temporary view structure for view `vehiculos_detalles_tecnicos`
--

DROP TABLE IF EXISTS `vehiculos_detalles_tecnicos`;
/*!50001 DROP VIEW IF EXISTS `vehiculos_detalles_tecnicos`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vehiculos_detalles_tecnicos` AS SELECT 
 1 AS `vehiculoId`,
 1 AS `anio`,
 1 AS `estado`,
 1 AS `fechaVerificacion`*/;
...
--
-- Temporary view structure for view `vehiculos_info_basica`
--

DROP TABLE IF EXISTS `vehiculos_info_basica`;
/*!50001 DROP VIEW IF EXISTS `vehiculos_info_basica`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vehiculos_info_basica` AS SELECT 
 1 AS `vehiculoId`,
 1 AS `flotillaId`,
 1 AS `tipo`,
 1 AS `modelo`,
...
--
-- Final view structure for view `conductores_info_licencia`
--
...
/*!50001 VIEW `conductores_info_licencia` AS select `conductor`.`conductorId` AS `conductorId`,`conductor`.`numeroLicencia` AS `numeroLicencia`,`conductor`.`vencimientoLicencia` AS `vencimientoLicencia` from `conductor` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `conductores_info_personal`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `conductores_info_personal` AS select `conductor`.`conductorId` AS `conductorId`,`conductor`.`nombre` AS `nombre`,`conductor`.`estado` AS `estado` from `conductor` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `documentos_archivos`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `documentos_archivos` AS select `documento`.`documentoId` AS `documentoId`,`documento`.`rutaArchivo` AS `rutaArchivo` from `documento` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `documentos_info_basica`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `documentos_info_basica` AS select `documento`.`documentoId` AS `documentoId`,`documento`.`vehiculoId` AS `vehiculoId`,`documento`.`tipo` AS `tipo`,`documento`.`fechaVencimiento` AS `fechaVencimiento`,`documento`.`estado` AS `estado` from `documento` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `mantenimiento_info_costo`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `mantenimiento_info_costo` AS select `mantenimiento`.`mantenimientoId` AS `mantenimientoId`,`mantenimiento`.`costo` AS `costo`,`mantenimiento`.`estado` AS `estado` from `mantenimiento` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `mantenimiento_info_servicio`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `mantenimiento_info_servicio` AS select `mantenimiento`.`mantenimientoId` AS `mantenimientoId`,`mantenimiento`.`vehiculoId` AS `vehiculoId`,`mantenimiento`.`fechaServicio` AS `fechaServicio`,`mantenimiento`.`tipoServicio` AS `tipoServicio`,`mantenimiento`.`descripcion` AS `descripcion` from `mantenimiento` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
--
-- Final view structure for view `rutas_info_conductor`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `rutas_info_conductor` AS select `ruta`.`rutaId` AS `rutaId`,`ruta`.`conductorId` AS `conductorId`,`ruta`.`estado` AS `estado` from `ruta` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `rutas_info_ruta`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `rutas_info_ruta` AS select `ruta`.`rutaId` AS `rutaId`,`ruta`.`vehiculoId` AS `vehiculoId`,`ruta`.`horaInicio` AS `horaInicio`,`ruta`.`horaFin` AS `horaFin`,`ruta`.`distancia` AS `distancia`,`ruta`.`ubicacionInicio` AS `ubicacionInicio`,`ruta`.`ubicacionFin` AS `ubicacionFin` from `ruta` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `rutas_pendientes`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `transacciones_diesel` AS select `transaccioncombustible`.`transaccionId` AS `transaccionId`,`transaccioncombustible`.`vehiculoId` AS `vehiculoId`,`transaccioncombustible`.`conductorId` AS `conductorId`,`transaccioncombustible`.`monto` AS `monto`,`transaccioncombustible`.`cantidad` AS `cantidad`,`transaccioncombustible`.`tipoCombustible` AS `tipoCombustible`,`transaccioncombustible`.`fechaTransaccion` AS `fechaTransaccion`,`transaccioncombustible`.`ubicacion` AS `ubicacion` from `transaccioncombustible` where (`transaccioncombustible`.`tipoCombustible` = 'Diésel') */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `transacciones_gasolina`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `transacciones_gasolina` AS select `transaccioncombustible`.`transaccionId` AS `transaccionId`,`transaccioncombustible`.`vehiculoId` AS `vehiculoId`,`transaccioncombustible`.`conductorId` AS `conductorId`,`transaccioncombustible`.`monto` AS `monto`,`transaccioncombustible`.`cantidad` AS `cantidad`,`transaccioncombustible`.`tipoCombustible` AS `tipoCombustible`,`transaccioncombustible`.`fechaTransaccion` AS `fechaTransaccion`,`transaccioncombustible`.`ubicacion` AS `ubicacion` from `transaccioncombustible` where (`transaccioncombustible`.`tipoCombustible` = 'Gasolina') */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
--
-- Final view structure for view `vehiculos_anio_2020`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vehiculos_anio_2020` AS select `vehiculo`.`vehiculoId` AS `vehiculoId`,`vehiculo`.`flotillaId` AS `flotillaId`,`vehiculo`.`tipo` AS `tipo`,`vehiculo`.`modelo` AS `modelo`,`vehiculo`.`marca` AS `marca`,`vehiculo`.`anio` AS `anio`,`vehiculo`.`estado` AS `estado`,`vehiculo`.`fechaVerificacion` AS `fechaVerificacion` from `vehiculo` where (`vehiculo`.`anio` = 2020) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vehiculos_anio_2021`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vehiculos_anio_2021` AS select `vehiculo`.`vehiculoId` AS `vehiculoId`,`vehiculo`.`flotillaId` AS `flotillaId`,`vehiculo`.`tipo` AS `tipo`,`vehiculo`.`modelo` AS `modelo`,`vehiculo`.`marca` AS `marca`,`vehiculo`.`anio` AS `anio`,`vehiculo`.`estado` AS `estado`,`vehiculo`.`fechaVerificacion` AS `fechaVerificacion` from `vehiculo` where (`vehiculo`.`anio` = 2021) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `vehiculos_detalles_tecnicos`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vehiculos_detalles_tecnicos` AS select `vehiculo`.`vehiculoId` AS `vehiculoId`,`vehiculo`.`anio` AS `anio`,`vehiculo`.`estado` AS `estado`,`vehiculo`.`fechaVerificacion` AS `fechaVerificacion` from `vehiculo` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
--
-- Final view structure for view `vehiculos_info_basica`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vehiculos_info_basica` AS select `vehiculo`.`vehiculoId` AS `vehiculoId`,`vehiculo`.`flotillaId` AS `flotillaId`,`vehiculo`.`tipo` AS `tipo`,`vehiculo`.`modelo` AS `modelo`,`vehiculo`.`marca` AS `marca` from `vehiculo` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2025-03-13 18:30:30
